...
physics_data = [
    ...
    # seesaw / levers
    ["weights", "A heavy and a light object are placed on a seesaw. Which object will move up?"],  # note that the setup is technically not well defined
    ["weights", "A heavy and a light object are placed on a seesaw. Which object will move down?"],  # reverse of before
    ["weights", "Two equal weight object are placed on a seesaw. Which object will move up?"],
    ["weights", "A heavy and a light object are placed on the same side of a seesaw. Which object will move down?"],  # 'trick' question
    ...
    # make-shift levers
    ["mechanisms", "A wooden beam is placed over a stone. A small plastic bottle is placed on one side. What will happen if a person jumps onto the other side of the beam?"],

    # mary move stone
    ["mechanisms", "Mary can not move a heavy stone by herself. However, she brought a small object and a metal rod with her. Is Mary able to move the stone?"],
    ["mechanisms", "Mary can not move a heavy stone by herself. However, she brought a small object and a metal rod with her. How can Mary move the stone?"], # introduce intention

    # mary lift stone
    ["mechanisms", "Mary can not lift a heavy stone by herself. However, she brought a small object and a metal rod with her. Is Mary able to lift the stone?"],
    ["mechanisms", "Mary can not lift a heavy stone by herself. However, she brought a small object and metal rod with her. How can Mary lift the stone?"],

    # mary brought an unhelpful object
    ["mechanisms", "Mary can not lift a heavy stone by herself. However, she brought a calculator with her. Is Mary able to lift the stone?"],
    ["mechanisms", "Mary can not lift a heavy stone by herself. However, she brought a calculator with her. How can Mary lift the stone?"],
]
